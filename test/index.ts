...
import { sound, Sound, utils, webaudio, filters, SoundLibrary, IMediaInstance } from '../';
...
describe(`PIXI.sound`, function ()
{
    ...
    {
        expect(sound.supported).to.be.true;
    ...
    it('should recreate the library', function ()
    {
        ...
        expect(sound.context).to.be.not.null;
    });
    ...
    it('should take AudioBuffer as source', function (done)
    {
        this.slow(300);
        const s = utils.sineTone(200, 0.1);
...
describe(`PIXI.sound.SoundInstance`, function ()
{
    ...
    {
        const SoundInstance = webaudio.WebAudioInstance;
